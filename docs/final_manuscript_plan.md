...
| 6 | **PhysioSpace-style stress resemblance** — which curated stress programmes the flight response resembles | g:Profiler GO 'response to' axes (`apex05_physiospace_stress.py`) | DESeq2 DEGs | **DONE.** Flight resembles **hypoxia, oxidative/ROS, defense (SA/JA)** — known spaceflight themes; cax2-2 matches none. (Resemblance/overlap, not directional projection) |
