...
# Generated by  iDEP 0.92  hosted at http://ge-lab.org/idep/  Wed Jul  1 18:30:15 2020 
...
geneSetFile <- 'Arabidopsis_thaliana__athaliana_eg_gene.db'   
...
## These Bioconductor packages cannot be loaded: DESeq2 gage PGSEA fgsea pathview PREDA runibic QUBIC STRINGdb 
##  PREDAsampledata hgu133plus2.db Error: package or namespace load failed for ‘RSQLite’ in loadNamespace(i, c(lib.loc, .libPaths()), versionCheck = vI[[i]]):
##   namespace ‘vctrs’ 0.2.0 is already loaded, but >= 0.2.1 is required
## So i installed these packages / libraries individualy incease it might help... 
...
## What is the geneInfo file strcuture?
##allGeneInfo.out <- geneInfo(Arabidopsis_thaliana__athaliana_eg_gene_GeneInfo.csv)
...
input_selectFactorsHeatmap <- 'Variety'	#Sample coloring factors 
...
# 5. PCA and beyond 
##########################
input_selectFactors <- 'Hardware'	#Factor coded by color
...
# 7. DEG2 
##########################
input_selectContrast <- 'GLDS121-GLDS120'	#Selected comparisons 
...
# 8. Pathway analysis 
##########################
input_selectContrast1 <- 'GLDS121-GLDS120'	#select Comparison 
...
GeneSets.out <-readGeneSets( geneSetFile,
                             ...
                             c(input_minSetSize, input_maxSetSize)  ) 
input_selectWGCNA.Module <- '1. turquoise (542 genes)'	#Select a module
