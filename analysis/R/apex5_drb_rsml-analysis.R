...
# Note: The following paths were legacy laptop folders and are commented out to prevent syntax errors:
...
# If the target directory exists, read it
if (dir.exists(path)) {
  ...
  # Mock an empty or template table to prevent parsing failures
